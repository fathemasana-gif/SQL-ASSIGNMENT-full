...
INSERT INTO employees (employee_id, employee_name, gender, age, hire_data, designation, department_id, location_id, salary) VALUES
...
-- 2 LIMIT
SELECT*FROM employees
where hire_data >= '2018-01-01'
AND hire_data< '2019-01-01'
ORDER BY hire_data ASC
LIMIT 5;
...
--  avg salary by designation containg analyst
SELECT designation,
...
-- female employee by location whose  age below 30
SELECT location_id,
